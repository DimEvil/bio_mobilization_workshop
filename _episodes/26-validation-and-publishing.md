...
> * Check that all the [required Darwin Core terms]({{ site.baseurl }}/assets/25-metadata.md#required-eml-metadata-fields-for-sharing-to-gbif) are present and contain the correct information.
